...
public class ForecastFragment extends Fragment {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_refresh) {
            ...
            fetchWeatherTask.execute("Helsinki");
            return true;
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String[] data = {
                "Mon 7/11 - Cloudy - 20/12",
                "Tue 7/12 - Sunny - 20/15",
                "Wed 7/13 - Rainy - 17/14",
                "Thu 7/14 - Cloudy - 19/15",
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
                   ...
                   throws JSONException
        {
            ...
            // we start at the day returned by local time. Otherwise
            // this is a mess.
...
//                JSONObject timeObject = dayForecast.getJSONObject("dt_txt");
                String time = dayForecast.getString("dt_txt");
//                String time = timeObject.getString();

                highAndLow = formatHighLows(high, low);
                Log.v(LOG_TAG, "Temperatures: " + highAndLow);
//                resultStrs[i] = day + " - " + description + " - " + highAndLow;
                resultStrs[i] = time.substring(5,13) + " - " + description
                                + " - temp " + temperature + "\u00b0" + "C"
                                + " - wind " + windSpeed + "m/s";
        ...
        protected String[] doInBackground(String... params) {
            ...
            try {
                ...
                Uri builtUri = Uri.parse(FORECAST_BASE_URL).buildUpon()
                        ...
                        .appendQueryParameter(APPID_PARAM, "f6391a9e3920e01c4c56daf988675216")
                        .build();

                //URL url = new URL(builtUri.toString());
                URL url = new URL("http://api.openweathermap.org/data/2.5/forecast?q=Helsinki&units=metric&appid=f6391a9e3920e01c4c56daf988675216");
                ...
                Log.v("MIKA", "reader=" + reader.toString());
                String line;
